export const ynETH_0x14dcAbi = [
  ...
  },
  {
    ...
    name: "CallerNotStakingNodeManager",
    type: "error",
  },
  {
    inputs: [
  ...
  { inputs: [], name: "NoDirectETHDeposit", type: "error" },
  { inputs: [], name: "NotInitializing", type: "error" },
  { inputs: [], name: "NotRewardsDistributor", type: "error" },
  { inputs: [], name: "Paused", type: "error" },
  { inputs: [], name: "TransferFailed", type: "error" },
  { inputs: [], name: "TransfersPaused", type: "error" },
  { inputs: [], name: "ZeroAddress", type: "error" },
  { inputs: [], name: "ZeroETH", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  {
    inputs: [
      { internalType: "address[]", name: "unlisted", type: "address[]" },
    ],
